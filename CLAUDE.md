...
## Recent Changes (Session 8 — July 12, 2026)
...
- ⬜ Session 9 — Homepage case study grid (wire up the "// case studies" placeholder). Note: DB now has 7 studies — the extra `payments-dashboard` (Order 1, Published) needs an ordering decision before wiring the grid.
